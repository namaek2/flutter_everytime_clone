                ...
                SafeArea(
                    child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            circleLink('https://www.jbnu.ac.kr',
                                "home",
                                '학교\n홈'),
                            circleLink('https://www.jbnu.ac.kr/kor/?menuID=460',
                                "earth",
                                '포털'),
                            circleLink('https://www.jbnu.ac.kr/kor/?menuID=57',
                                "bus",
                                '셔틀\n버스'),
                            circleLink('https://www.jbnu.ac.kr/kor/?menuID=139',
                                "notification",
                                '학사\n공지'),
                            circleLink('https://www.jbnu.ac.kr/kor/?menuID=19',
                                "schedule",
                                '학사\n일정'),
                            circleLink('https://dl.jbnu.ac.kr/',
                                "book",
                                '도서관'),
                          ],
                        ))),
                    ...
                    child: Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              favoritePost(context, '장터게시판', '노트북 저렴하게 팔아요'),
                            ])),
                  ),
                ),
                Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              popularPost(context, '전승혁 혼자하는 팀프로젝트 너무 행보케...',
                                  '★★★★★★★★카톡 읽씹하고 절대 안모이는 팀플 너무 힘들다', '자유게시판', '63', '76'),
